...
2.	Override standalone.xml, mgmt-users.properties, mgmt-groups.properties from attachment in directory WILDFLY_HOME\standalone\configuration (in repo tools folder)
...
Build and deploy all application:
